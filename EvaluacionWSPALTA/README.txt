...
a persistence unit "EvaluacionWSPALTAPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSPALTA\pom.xml":
...
artifact ("EvaluacionWSPALTA.war") is already built. You can build
